...
public class MainAdapter extends FragmentPagerAdapter {
    ...
    public MainAdapter(FragmentManager fm, Context context, EventFragment eventFragment, TeamFragment teamFragment, ChatFragment chatFragment, MyFragment myFragment) {
        super(fm);
        this.titles = new String[]{context.getResources().getString(R.string.title_event), context.getResources().getString(R.string.title_team), context.getResources().getString(R.string.title_chat), context.getResources().getString(R.string.title_my)};
