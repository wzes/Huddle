...
public class TeamNewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(C0479R.layout.fragment_team_item_new, container, false);
        this.recyclerView = (RecyclerView) view.findViewById(C0479R.id.team_new_recyclerView);
        this.refreshLayout = (SwipeRefreshLayout) view.findViewById(C0479R.id.team_new_refreshLayout);
