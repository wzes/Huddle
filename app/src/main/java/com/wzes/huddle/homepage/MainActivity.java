...
public class MainActivity extends AppCompatActivity {
    ...
    class C09061 implements OnNavigationItemSelectedListener {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case C0479R.id.navigation_team /*2131624329*/:
                    MainActivity.this.mViewPager.setCurrentItem(1);
                    return true;
                case C0479R.id.navigation_event /*2131624330*/:
                    MainActivity.this.mViewPager.setCurrentItem(0);
                    return true;
                case C0479R.id.navigation_chat /*2131624331*/:
                    MainActivity.this.mViewPager.setCurrentItem(2);
                    return true;
                case C0479R.id.navigation_my /*2131624332*/:
    ...
    class C09072 implements OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            switch (position) {
                case 0:
                    MainActivity.this.navigation.setSelectedItemId(C0479R.id.navigation_event);
                    return;
                case 1:
                    MainActivity.this.navigation.setSelectedItemId(C0479R.id.navigation_team);
                    return;
                case 2:
                    MainActivity.this.navigation.setSelectedItemId(C0479R.id.navigation_chat);
                    return;
                case 3:
                    MainActivity.this.navigation.setSelectedItemId(C0479R.id.navigation_my);
                    return;
                default:
                    return;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.navigation = (BottomNavigationView) findViewById(C0479R.id.navigation);
